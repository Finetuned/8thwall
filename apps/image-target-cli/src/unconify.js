 ...
 * @param {number} p1 - First value
 * @param {number} p2 - Second value
...
/**
 * Get RGB color from image data at (x, y).
...
/**
 * Bilinear interpolation of RGB color at a 2D point.
 * @param {ImageData} pix - Source image data
 * @param {Point} pt - Sampling point
 * @returns {Color} Interpolated color
 */
...
/**
 * Sample image using linear interpolation at given points.
 * @param {ImageData} pix - Source image data
 * @param {Point[]} samplingPoints - Points to sample
 * @param {ImageData} outputImg - Output image data
 */
...
// the y axis.
/**
 * Compute cone pixel points from radii and width.
 * @param {number} topRadius - Top radius
 * @param {number} bottomRadius - Bottom radius
 * @param {number} width - Image width
 * @returns {ConePixelPoints} Cone pixel points
 */
...
/**
 * Get unconified geometry data from pixel points.
 * @param {ConePixelPoints} pixelPoints - Cone pixel points
 * @param {number} outputWidth - Output image width
 * @returns {UnconifiedData} Unconified geometry data
 */
